...
use crate::async_kms::{KmsClient, KmsClientFactory, KmsClientRef, KmsConnectionConfig};
...
impl TestKmsClientFactory {
    ...
    pub async fn invocations(&self) -> Vec<KmsConnectionConfigDetails> {
    ...
    async fn create_client(
    ...
    ) -> Result<KmsClientRef> {
        {
            let details = KmsConnectionConfigDetails {
                ...
                key_access_token: kms_connection_config.key_access_token().await,
